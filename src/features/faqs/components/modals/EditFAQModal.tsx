...
import { FAQ, UpdateFAQRequest, FAQStatus } from '@/types/faqs';
...
const EditFAQModal: React.FC<EditFAQModalProps> = ({ isOpen, onClose, onSuccess, faq }) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const response = await updateFAQ(updateData);
